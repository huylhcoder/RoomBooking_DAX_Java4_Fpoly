         ...
         <div class="container">
           <div class="header clearfix">
            ...
            <!-- Thay chỗ này  /Tên project/vnpayajax-->
                <form action="/RoomBooking/vnpayajax" id="frmCreateOrder" method="Post">        
                    <div class="form-group">
                        <label for="amount">Số tiền cần thanh toán: <fmt:formatNumber value="${total}" type="number" groupingUsed="true" pattern="###,###" /> VND</label>
  						<!-- Thông tin cần được post và lưu vào session -->	
                        <input type="hidden" name="roomId" value="${roomId}"> 
						<input type="hidden" name="CheckIn" value="${CheckIn}"> 
						<input type="hidden" name="CheckOut" value="${CheckOut}"> 
						<input type="hidden" name="total" value="${total}">
                        <!-- Thay đổi cái giá chô này -->
                        <input value="${total}" class="form-control" data-val="true" data-val-number="The field Amount must be a number." data-val-required="The Amount field is required." id="amount" max="100000000" min="1" name="amount" type="hidden"  />
                    </div>
