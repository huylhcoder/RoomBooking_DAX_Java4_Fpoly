									...
									<div class="card-body">
										...
										<div class="tab-content">
											<div class="tab-pane active" id="detailManagerUser">
												...
												<form action="/RoomBooking/usermanager/index" method="post">
													<div class="mb-3">
														<label for="exampleInputUser" class="form-label">Tên
															...
															id="username" aria-describedby="UserHelp"
															 value="${formManagerUser.username}">
															 <span class="text-danger">${alertUsername}</span>
													</div>
													<div class="mb-3">
														<label for="exampleInputName" class="form-label">Password
															...
															id="password" aria-describedby="nameHelp"
															 value="${formManagerUser.password}">
															 <span class="text-danger">${alertPassword}</span>
													...
													<div class="mb-3">
														<label for="exampleInputName" class="form-label">Họ
															...
															id="fullname" aria-describedby="nameHelp"
															 value="${formManagerUser.fullname}">
													...
													<div class="mb-3">
														...
														<input type="email" name="email" name="email" class="form-control"
															id="email" aria-describedby="emailHelp"
															 value="${formManagerUser.email}">
															 <span class="text-danger">${alertEmail}</span>
													</div>
													<div class="mb-3">
														<label for="exampleInputPhone" class="form-label">Số
															điện thoại</label> <input type="number" name="phone" class="form-control"
															id="phone" aria-describedby="phoneHelp"
															 value="${formManagerUser.phone}">
															 <span class="text-danger">${alertPhone}</span>
													</div>
													<div>
														<button type="submit" class="btn btn-outline-success"
															formaction="/RoomBooking/usermanager/create">Create</button>
														<button type="submit" class="btn btn-outline-warning"
															formaction="/RoomBooking/usermanager/update">Update</button>										
														<a name="" id="updateBtn" class="btn btn-outline-primary"
															href="/RoomBooking/usermanager/index" role="button">Reset</a>
													</div>
															...
															<c:forEach var="item" items="${itemsManagerUser}"
																...
																<tr class="">
																	...
																	<td><a name="" id=""
																		...
																		href="/RoomBooking/usermanager/edit/${item.id}" role="button">Chi
																			tiết...</a></td>
